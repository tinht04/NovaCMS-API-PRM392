...
namespace NovaCMS.Infrastructure.Data;

public partial class NovaCMSDBContext : DbContext
{
    public NovaCMSDBContext()
    {
    }

    public NovaCMSDBContext(DbContextOptions<NovaCMSDBContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=mysql-database-tinht-fptu.b.aivencloud.com;port=20277;database=NovaCMS;user=avnadmin;password=AVNS_9YwLqVnHoOLgvuOYaGJ", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.35-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EquipmentItem>(entity =>
        {
            ...
            entity.Property(e => e.Specifications).HasColumnType("json");
            entity.Property(e => e.Specs).HasColumnType("text");
            entity.Property(e => e.Status)
                .HasDefaultValueSql("'Available'")
                .HasColumnType("enum('Available','Held','Rented','Maintenance','Lost')");
            entity.Property(e => e.WarrantyInfo).HasMaxLength(255);
